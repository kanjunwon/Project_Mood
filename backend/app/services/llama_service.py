...
SYSTEM_PREAMBLE = (
    ...
    "2. 담백하게 쓴다: 교훈적으로 정리하며 끝내지 않는다 ('~덕분에', '~을 선사했다', "
    "'~라는 걸 느꼈다' 같은 문장으로 마무리하지 않는다). 과장된 비유도 쓰지 않는다 "
    "('마법처럼', '환상적인' 등). 그냥 있었던 일 적고 끝내거나 사소한 잡생각으로 "
    "끝나도 된다.\n"
...
# '~덕분에', '~을 선사했다' 계열 교훈형 마무리 걸러내기
# (지난번에 '~을 선사한다'가 새로 걸린 걸 반영해서 '선사' 추가함)
CLICHE_PATTERNS = (
